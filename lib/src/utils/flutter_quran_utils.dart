...
import 'package:mushaf/src/app_bloc.dart';
import 'package:mushaf/src/models/ayah.dart';
import 'package:mushaf/src/models/bookmark.dart';
import 'package:mushaf/src/models/surah.dart';
...
class Mushaf {
  /// [init] initializes the Mushaf, and must be called before starting using the package
  Future<void> init(
