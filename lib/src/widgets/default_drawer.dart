...
class _DefaultDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final jozzs = Mushaf().getAllJozzs();
    final hizbs = Mushaf().getAllHizbs();
    final surahs = Mushaf().getAllSurahs();
    return Drawer(
      child: ListView(
        children: [
          ListTile(
            ...
            onTap: () async {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (ctx) => const _MushafSearchScreen()));
            },
          ),
          ExpansionTile(
                ...
                children: List.generate(
                    ...
                    (jozzIndex) => ExpansionTile(
                          ...
                          children: List.generate(2, (index) {
                            ...
                            return InkWell(
                              onTap: () {
                                Mushaf().navigateToHizb(hizbIndex + 1);
                              },
                              child: Padding(
                                padding:
              ...
              ExpansionTile(
                ...
                children: List.generate(
                    ...
                    (index) => GestureDetector(
                        onTap: () => Mushaf().navigateToSurah(index + 1),
                        child: Padding(
              ...
              Column(
                children: Mushaf()
                    ...
                    .map((bookmark) => ListTile(
                          ...
                          onTap: () =>
                              Mushaf().navigateToBookmark(bookmark),
                        ))
                    .toList(),
              ),
            ],
