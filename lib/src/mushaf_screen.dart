...
import 'package:mushaf/src/utils/string_extensions.dart';
...
class _MushafSearchScreen extends StatefulWidget {
  const _MushafSearchScreen();

  @override
  State<_MushafSearchScreen> createState() =>
      _MushafSearchScreenState();
}

class _MushafSearchScreenState extends State<_MushafSearchScreen> {
  List<Ayah> ayahs = [];
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                TextField(
                  onChanged: (txt) {
                    final searchResult = Mushaf().search(txt);
                    setState(() {
                      ayahs = [...searchResult];
                    });
                  },
