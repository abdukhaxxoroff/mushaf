...
class BookmarksCtrl extends GetxController {
  ...
  //   BookmarkModel(id: 0, colorCode: greenHighLightColor, name: 'العلامة الصفراء'),
  //   BookmarkModel(id: 1, colorCode: yellowHighLightColor, name: 'العلامة الحمراء'),
  ...
  void initBookmarks(
    ...
    if (overwrite) {
      ...
      if (savedBookmarks.isEmpty) {
        ...
        bookmarks[greenHighLightColor] = []; // اللون الأصفر
        bookmarks[yellowHighLightColor] = []; // اللون الأحمر
        bookmarks[redHighLightColor] = []; // اللون الأخضر
        bookmarks[blueHighLightColor] = []; // اللون الأخضر
      } else {
