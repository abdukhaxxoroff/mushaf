...
class QuranRepository {
  ...
  Future<List<dynamic>> getQuran() async {
    String content = await rootBundle
        .loadString('packages/mushaf/assets/jsons/quran_hafs.json');
  ...
  Future<Map<String, dynamic>> getSurahs() async {
    String content = await rootBundle
        .loadString('packages/mushaf/assets/jsons/surahs_name.json');
    return jsonDecode(content);
  }
  ...
  Future<List<dynamic>> getFontsQuran() async {
    String jsonString = await rootBundle
        .loadString('packages/mushaf/assets/jsons/quranV2.json');
